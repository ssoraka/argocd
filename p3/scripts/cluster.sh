...
# cluster
k3d cluster create mycluster --servers 1 --agents 0 -p "8080:80@loadbalancer" -p "8082:443@loadbalancer" -p "8888:8888@loadbalancer" -p "8181:8181@loadbalancer" -p "8081:8081@loadbalancer"
